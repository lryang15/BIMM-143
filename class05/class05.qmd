...
The ggplot2 package needs to be installed as it does not come with R "out of
the box".
...
To use ggplot I need to load it up before I can call any of the functions in
