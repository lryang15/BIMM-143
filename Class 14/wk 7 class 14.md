...
![](wk-7-class-14_files/figure-commonmark/unnamed-chunk-9-1.png)
...
![](wk-7-class-14_files/figure-commonmark/unnamed-chunk-10-1.png)
...
Use the gage package for pathway analysis and the pathview package to
...
`gage()` function requires a named vector of fold changes, where the
...
The value of same.dir determines whether to test for changes in a gene
set toward a single direction (all genes up or down regulated) or
changes towards both directions simultaneously (i.e. any genes in the
...
Pathway plot with our RNA-Seq expression results shown in color with
`pathview()`
...
```
    ...
    Info: Working in directory /Users/lenayang/Downloads/bimm 143/bim143_github/Class 14
...
![](hsa04114.pathview.png) ![](hsa03030.pathview.png)
...
most significant pathways listed do not match my previous KEGG results
for both up and down regulated genes. The only pathway matched is cell
cycle for down regulated pathway. The differences between the two
methods could be due to the different databases they are drawing
information from.
